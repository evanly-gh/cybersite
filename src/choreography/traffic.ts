...
export function buildTraffic(rng: Rng): TrafficSystem {
  ...
  // Research canyon: ground-level corridor from skywayStart→skywayEnd (formerly elevated skyway)
  const uCanyonStart  = ROUTE_U.skywayStart;
  const uCanyonEnd    = ROUTE_U.skywayEnd;
