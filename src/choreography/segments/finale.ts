 ...
 *
 * ARCHITECTURE:
 *  The money shot. Bike accelerates from researchEnd onto the ocean bridge,
 ...
 *
 * SPEED KEYS:
 *  Research ended at t=0.79 with u = ROUTE_U.researchEntry + 0.65*(ROUTE_U.researchEnd - ROUTE_U.researchEntry).
